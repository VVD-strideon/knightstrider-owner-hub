...
export default function ToolkitSection({ onDownload }) {
  return (
    <section id="toolkit" className="relative py-16 lg:py-24 overflow-hidden bg-white">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          ...
          >
            <div>
              <p className="text-gray-500 font-extrabold text-lg tracking-wider uppercase">GET YOUR</p>
              <h2 className="font-display font-extrabold leading-tight">
                <span className="text-primary text-4xl sm:text-5xl block">FREE</span>
            ...
            <div className="space-y-3 pt-2">
              <Button
                ...
                className="w-full bg-primary hover:bg-primary/90 text-white font-extrabold text-lg py-6 rounded-xl uppercase tracking-wide glow-orange transition-all hover:scale-[1.01] shadow-lg"
              >
                <Download className="w-5 h-5 mr-2" />
                DOWNLOAD YOUR FREE TOOLKIT NOW
              </Button>
              <div className="flex items-center justify-center gap-4 text-gray-500 text-xs font-semibold">
